...
■ OpenFracture
  Copyright (c) 2022 Daniel Greenheck
  MIT License
  https://github.com/dgreenheck/OpenFracture

  本ソフトウェアは MIT ライセンスのもとで配布されている
  OpenFracture を使用しています。
...
Copyright 2020 The Zen Kaku Gothic Project Authors
(https://github.com/googlefonts/zen-kakugothic)

This Font Software is licensed under the SIL Open Font
License, Version 1.1. This license is copied below,
...
support the font creation efforts of academic and
...
works, can be bundled, embedded, redistributed and/or
sold with any software provided that any reserved names
are not used by derivative works. The fonts and
derivatives, however, cannot be released under any other
type of license. The requirement for fonts to remain
